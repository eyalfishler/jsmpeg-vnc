(function (window) {
    ...
    jsmpeg.prototype.decodeSocketHeader = function (data) {
		...
		data[3] == SOCKET_MAGIC_BYTES.charCodeAt(3)
            ...
            console.log("calling initBuffer " + this.width + " " + this.height);
            this.initBuffers();
    ...
    jsmpeg.prototype.receiveSocketMessage = function (event) {
        ...
        if (messageData[0] == 106 && messageData[1] == 115 && messageData[2] == 109 && messageData[3] == 112) {
    ...
    jsmpeg.prototype.recordFrame = function () {
        ...
        this.recordBuffers.push(new Uint8Array(this.buffer.bytes.subarray(8, this.buffer.writePos)));
    ...
    jsmpeg.prototype.pictureRate = 45;
    ...
    jsmpeg.prototype.decodeSequenceHeader = function () {
        console.log("decodeSequenceHeader");
